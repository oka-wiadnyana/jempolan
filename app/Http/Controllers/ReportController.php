...
class ReportController extends Controller
{
    ...
    public function downloadMonev($id)
    {
        ...
        header("Content-Disposition: attachment; filename=Form-Laporan-Mingguan-" . time() . ".docx");
