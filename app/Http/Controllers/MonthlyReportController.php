...
class MonthlyReportController extends Controller
{
    ...
    public function downloadMonev(Request $request)
    {
        ...
        header("Content-Disposition: attachment; filename=Form-Laporan-Bulanan-".$request->jenis_laporan."-" . time() . ".docx");
