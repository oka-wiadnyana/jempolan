<x-layout.main>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('/insert_monev_mingguan') }}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div x-data="{show_submit:{{ $mode!='edit'?'true':'false' }} }" class="col-1">
                                ...
                                <a x-show="show_submit"  href="{{ url('report/mingguan/'.$level_name) }}" class="btn btn-secondary" @set-show.window="show_cancel=$event.detail.submit_cancel">Kembali</a>
                            ...
                            <div x-data="{show_cancel:false}" class="col-1">
                                ...
                                <a x-show="show_cancel"  href="{{ url('report/mingguan/'.$level_name) }}" class="btn btn-secondary" @set-show.window="show_cancel=$event.detail.submit_cancel">Kembali</a>
                      ...
                      <div class="row">
                            ...
                            <div class="col" x-data="{show_edit:{{ $mode=='edit'?'true':'false' }} }" >
                                ...
                                <a href="{{ url('report/mingguan/'.$level_name) }}" class="btn btn-secondary" x-show="show_edit"  @set-show.window="show_edit=$event.detail.edit">Kembali</a>
    ...
    <livewire:modal-detail-laporan-mingguan /> --}}
    @push('foot')
        <script>
            
            function showModalTambahLaporanMingguan(unit){
                console.log(unit);
                Livewire.dispatch('show-modal-tambah-laporan-mingguan',{'unit':unit});
            }
            function showModalEdit(id){
                Livewire.dispatch('show-modal-edit-laporan-mingguan',{'id':id});
            }
            function showModalDetail(id){
                Livewire.dispatch('show-modal-detail-laporan-mingguan',{'id':id});
            }
            ...
            function deleteLaporan(id){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.post('{{ url("/report/delete_laporan_mingguan") }}', {
                            id: id,
