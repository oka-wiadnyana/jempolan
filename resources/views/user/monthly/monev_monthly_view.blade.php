<x-layout.main>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('/insert_monev_bulanan') }}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div x-data="{show_submit:{{ $mode!='edit'?'true':'false' }} }" class="col-1">
                                ...
                                <a x-show="show_submit"  href="{{ url('report/bulanan/'.$level_name) }}" class="btn btn-secondary" @set-show.window="show_cancel=$event.detail.submit_cancel">Kembali</a>
                            ...
                            <div x-data="{show_cancel:false}" class="col-1">
                                ...
                                <a x-show="show_cancel"  href="{{ url('report/bulanan/'.$level_name) }}" class="btn btn-secondary" @set-show.window="show_cancel=$event.detail.submit_cancel">Kembali</a>
