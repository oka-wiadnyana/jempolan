<x-layout.main>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('/insert_tl_triwulan') }}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div x-data="{show_submit:{{ $mode!='edit'?'true':'false' }} }" class="col-1">
                                ...
                                <a x-show="show_submit"  href="{{ url('report/triwulan/'.$level_name) }}" class="btn btn-secondary" >Kembali</a>
                        ...
                        <div x-data="{show_edit:{{ $mode=='edit'?'true':'false' }} }" >
                            ...
                            <a href="{{ url('report/triwulan/'.$level_name) }}" class="btn btn-secondary" x-show="show_edit"  @set-show.window="show_edit=$event.detail.edit">Kembali</a>
