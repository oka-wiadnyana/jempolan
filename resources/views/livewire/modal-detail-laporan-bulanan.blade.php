        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content rounded-3">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail laporan Bulanan</h5>
                ...
                <div class="modal-body">
                   <form >
                    ...
                    <div class="form-group">
                        <label for="">Tahn</label>
                        <input type="text" name="report_date" id="" class="form-control" value="{{ $report_data?->year }}" disabled>
                    </div>
                   @if ($report_data?->file)
                   <div class="form-group">
                       
                        <a href="{{ asset('monthly_file/'.$report_data->file) }}" class="btn btn-success" target="_blank">Download</a>
                    </div>
                   @endif
