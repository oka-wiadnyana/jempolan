        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content rounded-3">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail laporan Semester</h5>
                ...
                <div class="modal-body">
                   <form >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="report_date" id="" class="form-control" value="{{ $report_data?->semester}}" disabled>
                    </div>
                    <div class="form-group">
                   ...
                   <div class="form-group">
                        ...
                        <a href="{{ asset('semester_file/'.$report_data->file) }}" class="btn btn-success" target="_blank">Download</a>
                    </div>
                   @endif
