        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content rounded-3">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah laporan Semester</h5>
                ...
                <div class="modal-body">
                   <form action="{{ url('report/insert_laporan_semester') }}" method="POST" enctype="multipart/form-data">
                    @csrf
