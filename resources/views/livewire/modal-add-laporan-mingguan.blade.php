        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content rounded-3">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah laporan Mingguan</h5>
                ...
                <div class="modal-body">
                   <form action="{{ url('report/insert_laporan_mingguan') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="week" id="" class="form-control">
                            <option value="" selected disabled>Pilih</option>
                            <option value="I">Pertama</option>
                            <option value="II">Kedua</option>
                            <option value="III">Ketiga</option>
                            <option value="IV">Keempat</option>
                            <option value="V">Kelima</option>
                        </select>
                    </div>
                    <div class="form-group">
