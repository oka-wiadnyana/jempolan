        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content rounded-3">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail laporan Tahunan</h5>
                ...
                <div class="modal-body">
                   ...
                   <div class="form-group">
                        ...
                        <a href="{{ asset('yearly_file/'.$report_data->file) }}" class="btn btn-success" target="_blank">Download</a>
                    </div>
                   @endif
