                   ...
                   <form action="{{ url('report/edit_laporan_mingguan') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="week" id="" class="form-control">
                            ...
                            <option value="I" @selected($report_data?->week=="I")>I</option>
                            <option value="II" @selected($report_data?->week=="II")>II</option>
                            <option value="III" @selected($report_data?->week=="III")>III</option>
                            <option value="IV" @selected($report_data?->week=="IV")>IV</option>
                            <option value="V" @selected($report_data?->week=="V")>V</option>
